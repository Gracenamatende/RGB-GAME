...
const colorDispalyElement= document.getElementById("color-display")
...
function setHeaderRgbBackgroundColor(squareElement){
    ...
    colorDispalyElement.dataset.rgb_value= rgbString;
...
//add eventlistener to square so that it either disappears or changes all squares to header color.
squares.forEach((square) =>{
    square.addEventListener("click", function(){
        const headerRgbvalue= colorDispalyElement.dataset.rgb_value;
...
function setSquareBackgroundAfterwin(headerRgbString){
    ...
    squares.forEach((sq)=> {
        ...
        sq.dataset.rgb_value=colorDispalyElement.dataset.rgb_value;
    });
}